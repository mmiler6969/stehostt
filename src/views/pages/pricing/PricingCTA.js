      ...
      <Grid container spacing={5}>
        <Grid item xs={12} md={8}>
          <Typography variant='h5' sx={{ mb: 2.5, color: 'primary.main' }}>
            Wciąż niezdecydowany? Przetestuj ofertę bez zobowiązań przez 30 dni
          </Typography>
          <Typography sx={{ mb: 10, color: 'text.secondary' }}>
            Otrzymasz dostęp do wszystkich naszych usług przez 30 dni za darmo!
          </Typography>
          <Button variant='contained'>Rozpocznij 30 dniowy okres testowy</Button>
        </Grid>
