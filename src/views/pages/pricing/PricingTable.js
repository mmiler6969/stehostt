    ...
    <div>
      <Box sx={{ mb: 12, textAlign: 'center' }}>
        <Typography variant='h5' sx={{ mb: 2.5 }}>
          Wybierz plan, który najlepiej Ci odpowiada
        </Typography>
        <Typography variant='body2'>Bądź spokojny, oferujemy 48-godzinną gwarancję zwrotu pieniędzy!</Typography>
      </Box>
            ...
            <TableBody>
              ...
              <TableRow sx={{ '& .MuiTableCell-root': { border: 0 } }}>
                ...
                <TableCell align='center' sx={{ whiteSpace: 'nowrap' }}>
                  <Button variant='outlined'>Wybierz plan</Button>
                </TableCell>
                <TableCell align='center' sx={{ whiteSpace: 'nowrap' }}>
                  <Button variant='contained'>Wybierz plan</Button>
                </TableCell>
                <TableCell align='center' sx={{ whiteSpace: 'nowrap' }}>
                  <Button variant='outlined'>Wybierz plan</Button>
                </TableCell>
